...
const shadowHeader = () => {
  ...
  // When we scroll is greater than 50 viewpoint height, add 'shadow-header' class to the header
  this.scrollY >= 50
...
const scrollUp  = () =>{
    ...
    // when the scroll is higher than 360 viewpoint add show-scroll class
...
sr.reveal(`.home__name, .home__info, .about__container,
            .section__title-1, .about__info, .contact__social,
